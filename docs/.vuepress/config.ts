        ...
        '/':{
            ...
            sidebar: {
                '/guide/': [
                    {
                        text: '指南',
                        children: ['/guide/README.md','/guide/getting-started.md', '/guide/memo','/guide/list','/guide/short-term-memory', '/guide/memory-palace', '/guide/action-library', '/guide/settings', '/guide/openai', '/guide/advance'],
                    },
                ],
                '/keyboard-guide/': [
                    {
